            ...
            <div class="panel panel-forum">
                ...
                <ul class="forum-list">
                    <li>
                        <!-- begin media -->
                        <div class="media">
                            <img src="assets/img/icon-gold-note.png" alt="" />
                        </div>
                        <!-- end media -->
                    ...
                    <li>
                        <!-- begin media -->
                        <div class="media">
                            <img src="assets/img/icon-cone.png" alt="" />
                        </div>
                        <!-- end media -->
                        <!-- begin info-container -->
                        <div class="info-container">
            ...
            <div class="panel panel-forum">
                ...
                <ul class="forum-list">
                    <li>
                        <!-- begin media -->
                        <div class="media">
                            <img src="assets/img/icon-chat-bubble.png" alt="" />
                        </div>
                        <!-- end media -->
                        <!-- begin info-container -->
                        <div class="info-container">
            ...
            <div class="panel panel-forum">
                ...
                <ul class="forum-list">
                    <li>
                        <!-- begin media -->
                        <div class="media">
                            <img src="assets/img/icon-discussion-grey.png" alt="" />
                        </div>
                        <!-- end media -->
                        <!-- begin info-container -->
                        <div class="info-container">
