    ...
    <div class="box" >
        <div class="padding-md ">
            <div class="list-group text-center">
                ...
                <a href="{{ route('user.avatar_edit') }}" class="list-group-item {{ navViewActive('user.avatar_edit') }}">
                    <i class="text-md fa fa-picture-o" aria-hidden="true"></i>
                    &nbsp;修改头像
                </a>
                <a href="{{ route('notifications') }}" class="list-group-item {{ navViewActive('notifications') }} ">
