            ...
            <div class="col-md-9  left-col ">
                <div class="panel panel-default padding-md" style="border-style: solid; border-width: 1px;border-color: #ccc">
                    ...
                    <form method="POST" action="https://laravel-china.org/users/16876/update_avatar" enctype="multipart/form-data" accept-charset="UTF-8">
                        <input name="_method" value="PATCH" type="hidden"><input name="_token" value="f8TVcFaqDkkmHrvXwQakNOgjVFawqOdq4dbirdrz" type="hidden"><div id="image-preview-div">
                            <label for="exampleInputFile">请选择图片：</label>
                            <br><img id="preview-img" class="avatar-preview-img" src="https://dn-phphub.qbox.me/uploads/avatars/16876_1510997257.jpg?imageView2/1/w/380/h/380">
                        </div>
